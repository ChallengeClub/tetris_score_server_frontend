class ResultModel{
    ...
    ResultModel.fromJson(dynamic map)
      : id = map['Id'],
        ...
        status = map['Status'] ?? "",
        branch = map['Branch'] ?? "",
        created_at = map['CreatedAt'] ?? 0,
        started_at = map['StartedAt'] ?? 0,
        ended_at = map['EndedAt'] ?? 0,
        mean_score = map['MeanScore'] ?? 0,
        game_time = map['GameTime'] ?? 0,
        level = map['Level'] ?? 1,
        game_mode = map['GameMode'] ?? "",
        predict_weight_path = map['ValuePredictWeight'] ?? "",
        trial_number = map['TrialNum'] ?? 0,
        stddev_score = map['StdDevScore'] ?? 0,
        max_score = map['MaxScore'] ?? 0,
        min_score = map['MinScore'] ?? 0,
