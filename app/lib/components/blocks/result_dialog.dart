...
class ResultDetailView extends HookConsumerWidget {

  @override
  Widget build(BuildContext context, WidgetRef ref, String id) {
    ResultModel.ResultModel result = ref.watch(resultDetailStateNotifierProvider);
    ref.read(resultDetailStateNotifierProvider.notifier).getResultDetailById(id);
