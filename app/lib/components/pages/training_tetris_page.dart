...
class TrainingTetrisPage extends HookConsumerWidget {
  final String _id;
  TrainingTetrisPage(this._id);
  final TextEditingController _codeEditingController = TextEditingController();

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    TrainingFormModel _state = ref.watch(trainingFormStateNotifierProvider(TrainingModel("tetris", _id, null,null,null,null,null,null,null,null,null,null,null,null,null,null,null)));
                                          ...
                                          return AlertDialog(
                                            ...
                                            actions: [
                                              ...
                                              TextButton(
                                                child: Text("OK"),
                                                onPressed: () {
                                                  ref.read(trainingFormStateNotifierProvider.call(_state.training).notifier).submitTetrisCode(
